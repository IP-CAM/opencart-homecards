...
class ControllerModuleHomecards extends Controller {
    protected function index($setting) {
        ...
        $filter_categories = $this->config->get('homecards_categories');
        ...
        $categories = $this->model_module_homecards->getCategories($filter_categories);
        $children_categories = $this->model_module_homecards->getChildrenCategories($filter_categories);

        foreach ($categories as $category) {
            $children = isset($children_categories[intval($category['category_id'])]) ? $children_categories[intval($category['category_id'])] : array();
            $children_data = array();
